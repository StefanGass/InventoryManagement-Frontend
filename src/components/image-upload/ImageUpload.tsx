        ...
        try{
            if (canvasRef != null && canvasRef.current != null && qrVideo.current != null) {
                ...
                if(canvas !=null){
                    ...
                    var image = new Image();
                    image.src = bild;
                    setPictureList(pictureList.concat(({ name: "test", base64: canvasRef.current.toDataURL()})));
                }
            }
        }catch(error){
           console.log(error);
            ...
            <Grid sx={{ cursor: `${disabled ? 'not-allowed' : 'pointer'}` }}>
                ...
                <div style={{display: 'flex'}}>
                    <video
                        ...
                        width="300px"
                        height="300px"
                        style={{ objectFit: 'cover' , marginTop: '50px', display: 'block' }}
                    />
                    ...
                    <canvas style={{marginRight: '10px'}}
                        ...
                        ref={canvasRef}
                    />
                    <Button onClick={(changeEvent) => makePicture(true)} style={{marginRight: '10px'}} >
                        Foto aufnehmen
                    </Button>
                </div>
